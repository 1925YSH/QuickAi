...
const AiTools = () => {
    ...
    return (
    <div className='px-4 sm:px-20 xl:px-21 my-24'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] font-semibold'>Powerful AI Tools</h2>
            <p className=' text-gray-500 max-w-lg mx-auto' >Everything you need to create, enhance, and optimize your content with cutting-edge
                AI technology.
            </p>
        </div>
        ...
        {AiToolsData.map((tool,index)=>(
            ...
            if (user) {
              ...
              openSignIn(); // 👈 opens Clerk sign-in popup modal
            }
          }}>
