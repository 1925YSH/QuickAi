...
border-gray-200 '>
       ...
       <p className=' mt-6 text-sm font-medium '>Describe object name to remove</p>
        ...
        <textarea onChange={(e)=> setObject(e.target.value)} value={object}  className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md
         border border-gray-300' required  placeholder='e.g., watch or spoon , only single object name' rows={4} />
      ...
      <button
        onClick={async () => {
          try {
            ...
            link.download = 'processed-object-image.png';
