  ...
  return !loading ? (
    <div className="flex-1 h-full flex flex-col gap-4 p-6">
      <div className=' flex items-center gap-3 '>
         <Sparkles className='w-6 text-[#e9200e] ' />
      ...
      items-end justify-end group-hover:justify-between p-3 group-hover:bg-gradient-to-b from-transparent to-black/80 text-white rounded-1g ">
